//0. Create a function that takes an array of numbers and returns a new array with the square of each number.
...
// const tryList = [1,2,3,4,5,6,7]
// eachNumSquared(tryList)


// 1. Create a function that takes in a number of two-pointers and three-pointers made and returns a basketball team’s total score. Console.log the results.
const teamScore = (twoP, threeP) => console.log(twoP + threeP)

teamScore(2,4)

 //2. Create a function that converts a string to uppercase letters. Console.log the results. 
